    ...
    <table>
      <tr>
        <td>
          ...
          $sql = "SELECT team_name FROM team ORDER BY teamID";
        ...
        <td>
          ...
          Goals Greater than: <input type="number" name="minGoalAmount" value="<?php if(isset($_POST['minGoalAmount'])) {
          ...
          Assists Greater than: <input type="number" name="minAssistAmount" value="<?php if(isset($_POST['minAssistAmount'])) {
          ...
          Shots Greater than: <input type="number" name="minShotAmount" value="<?php if(isset($_POST['minShotAmount'])) {
          ...
          Game Winning Goals greater than: <input type="number" name="minGWGAmount" value="<?php if(isset($_POST['minGWGAmount'])) {
          ...
          Penalty Minutes greater than: <input type="number" name="minPenaltyAmount" value="<?php if(isset($_POST['minPenaltyAmount'])) {
          ...
          Games Played greater than: <input type="number" name="minGamesAmount" value="<?php if(isset($_POST['minGamesAmount'])) {
